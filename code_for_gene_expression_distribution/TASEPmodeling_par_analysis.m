...
plot(fishTime, mean(fishSignal1,2), 'r-'); hold on; plot(fishTime, mean(fishSignal2,2), 'g-'); plot(fishTime, mean(fishSignal3,2), 'b-');

yyaxis right
ylabel('Protein per loci'); plot(fishTime, mean(proteinSS,2), 'k-'); hold off;
yyaxis left 
